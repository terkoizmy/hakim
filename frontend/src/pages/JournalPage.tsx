    ...
    <div className="pt-12">
      <div className="mx-auto w-full max-w-[1080px] px-6 pb-14">
        ...
        <header className="anim-in mb-[28px] border-b border-[#3a332a] pb-[24px]">
          <p className="mb-[10px] font-mono text-[11px] uppercase tracking-[2px] text-brass-500">Arsip Putusan</p>
          ...
          <p className="mt-3 max-w-[52ch] text-[14.5px] text-text-2">
            Semua perkara yang pernah diputuskan oleh majelis komite riset SIDANG.
          </p>
        </header>
          ...
          <div className="anim-in mb-5 flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="relative w-full max-w-[260px]">
              ...
              <input
                ...
                className="w-full rounded-lg border border-[#3a332a] bg-bg-2 py-1.5 pl-8 pr-3 font-mono text-[12px] text-text-0 placeholder:text-text-3 focus:border-brass-500 focus:outline-none focus:ring-1 focus:ring-brass-500"
              />
            </div>
          </div>
        )}
        ...
        {items === null ? (
          ...
          <div className="anim-in rounded-[14px] border border-[#3a332a] bg-bg-2 px-6 py-12 text-center">
            <p className="text-[14px] text-text-2">
              Tidak ada perkara yang cocok dengan filter atau kata kunci pencarian &quot;{search}&quot;.
            </p>
            <button
              type="button"
              onClick={() => {
              ...
              className="mt-3 font-mono text-[12px] text-brass-400 underline underline-offset-4 hover:text-brass-300"
            >
          ...
          <div className="anim-fade overflow-hidden rounded-[14px] border border-[#3a332a] bg-bg-2">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-[13px]">
                <thead>
                  <tr>
                    <th className={`${TH_CLS} pl-4 pr-2`}>Tanggal</th>
                    <th className={`${TH_CLS} px-2`}>Ticker</th>
                    <th className={`${TH_CLS} px-2`}>Emiten</th>
                    <th className={`${TH_CLS} px-2`}>Putusan</th>
                    <th className={`${TH_CLS} hidden px-2 lg:table-cell`}>Data</th>
                    <th className={`${TH_CLS} px-2 text-right`}>Harga Sidang</th>
                    <th className={`${TH_CLS} pl-2 pr-4 text-right`}>Aksi</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredList.map((it) => (
                    <tr key={it.memo_id} className="transition-colors hover:bg-[#1a1713] [&:last-child>td]:border-b-0">
                      ...
                      <td className={`${TD_CLS} hidden whitespace-nowrap px-2 lg:table-cell`}>
                        <InfoBadge>Info {it.info_richness}</InfoBadge>
                      </td>
                      ...
                      <td className={`${TD_CLS} whitespace-nowrap pl-2 pr-4 text-right`}>
                        <div className="flex items-center justify-end gap-1.5 font-mono text-[11.5px]">
                          <Link
                            ...
                            className="rounded border border-[#3a332a] bg-bg-3 px-2 py-0.5 text-brass-400 transition-colors hover:border-brass-500 hover:text-brass-200"
                          >
                            Memo
                          </Link>
                          <Link
                            ...
                            className="rounded border border-[#3a332a] bg-bg-3 px-2 py-0.5 text-brass-400 transition-colors hover:border-brass-500 hover:text-brass-200"
                            title="Post-mortem: evaluasi akurasi harga sejak putusan"
                          >
                            Post-mortem
                          </Link>
                        </div>
